...
: D3DApp(hInstance), mBoxVB(0), mBoxIB(0), mFX(0), mTech(0),
  ...
  mTheta(1.5f*MathHelper::Pi), mPhi(0.4f*MathHelper::Pi), mRadius(10.0f)
{
...
void BoxApp::UpdateScene(float dt)
{
	...
	XMVECTOR target = XMVectorSet(0, 1.0f, 0.0f, 0.0f);
...
void BoxApp::DrawScene()
{
    ...
    for(UINT p = 0; p < techDesc.Passes; ++p)
    {
		...
		md3dImmediateContext->DrawIndexed(100, 0, 0);
    }
...
void BoxApp::BuildGeometryBuffers()
{
    ...
    Vertex vertices[] =
    {
	    ...
	    { XMFLOAT3(-1.0f, +2.0f, -1.0f), XMFLOAT4((const float*)&Colors::Green) },
		{ XMFLOAT3(    0, +3.5f,     0), XMFLOAT4((const float*)&Colors::White)	},
		{ XMFLOAT3(+1.0f, +2.0f, -1.0f), XMFLOAT4((const float*)&Colors::Magenta) },
		{ XMFLOAT3(-1.0f, +2.0f, +1.0f), XMFLOAT4((const float*)&Colors::Blue)	},
